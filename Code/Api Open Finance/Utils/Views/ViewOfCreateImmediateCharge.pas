unit ViewOfCreateImmediateCharge;
...
type
  TViewOfCreateImmediateCharge = class(TForm)
    GroupBox3: TGroupBox;
...
procedure TViewOfCreateImmediateCharge.FormCreate(Sender: TObject);
begin
  Self.Position := poScreenCenter;
  InicializarComboBoxes;
end;

function TViewOfCreateImmediateCharge.GetIdemKey: String;
begin
  Result := txtIdemKey.Text;
end;

procedure TViewOfCreateImmediateCharge.InicializarComboBoxes;
begin
...
procedure TViewOfCreateImmediateCharge.btnCancelRequestClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TViewOfCreateImmediateCharge.btnConfirmRequestClick(Sender: TObject);
var
  DocLen: Integer;
begin
...
function TViewOfCreateImmediateCharge.GetBody: String;
var
...
begin
  ...
  try
    ...
    ImmediateCharge.Pagador := Pagador;
    ...
    ImmediateCharge.Favorecido := Favorecido;
    ...
    ImmediateCharge.Pagamento := Pagamento;
...
procedure TViewOfCreateImmediateCharge.ClearRequestFields;
begin
  txtIdemKey.Text := '';
